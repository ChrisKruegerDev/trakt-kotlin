...
class TraktShowsApi(
    ...
    suspend fun getTrending(
        ...
        client.getByPaths(*pathShows("trending")) {
            parameterPage(page)
    ...
    suspend fun getPopular(
        ...
        client.getByPaths(*pathShows("popular")) {
            parameterPage(page)
            parameterLimit(limit)
            extended?.let { parameterExtended(it) }
        }
    ...
    suspend fun getAnticipated(
        ...
        client.getByPaths(*pathShows("anticipated")) {
            parameterPage(page)
            parameterLimit(limit)
            extended?.let { parameterExtended(it) }
        }
    ...
    suspend fun getRelated(
        ...
        client.getByPaths(*pathShows(showId, "related")) {
            parameterPage(page)
            parameterLimit(limit)
            extended?.let { parameterExtended(it) }
        }
